...
Nous avons rencontré plusieurs difficultés pendant le développement du projet, notamment des difficultés liées à la maîtrise des
 outils nécessaires pour le développement de notre projet, et que nous avions jamais utilisés auparavant: React, JSX, Express etc..

D'autre part, le temps que nous avions prévu d'accorder à la partie modélisation et conception s'est rêvelé insuffisant. Nous avons donc été obligés d'accorder plus de temps à cette étape. Ceci a pu donc avoir des répercusions négatives sur notre livrable final.
...
Une autre limitation a été le serveur d'hébergement du département informatique, où a été mis en place des environnements node et npm ayant d'anciennes versions,
et où n'avions pas  accès à une base de données dediée a notre projet comme il nous a été promis. 
N'ayant pas les permissions necessaires, nous avons du nous contenter de tester localement l'ensemble des fonctionnalités de notre application.
%----------------------------------------------------------------------------------------
%   PERSPECTIVES
%----------------------------------------------------------------------------------------
