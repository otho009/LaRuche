...
\begin{frame}{Côté client}{Conception}
  ...
  \caption{Page d'accueil de l'utilisateur client}
  \end{figure}
\end{frame}
...
\caption{Gestion des commandes du point de vue du client}
\end{figure}
\end{frame}
...
%%PHP, MySQL
  \begin{figure}
    \begin{center}
      \includegraphics[scale=0.15]{images/mysql.png}
    \end{center}
  \end{figure}
  \begin{figure}
    \begin{center}
      \includegraphics[scale=0.15]{images/php.png}
    \end{center}
  \end{figure}
  \begin{figure}
    \begin{center}
      \includegraphics[scale=0.15]{images/symfony.png}
    \end{center}
  \end{figure}
  \begin{description}
