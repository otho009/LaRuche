...
\begin{frame}{\textit{React (Introduction)}}{Front-end}
  \begin{figure}[!ht]
    \includegraphics[scale=0.1]{images/reactlogo.png}
  \end{figure}
...
\begin{frame}{\textit{React (Organisation choisie)}}{Exemple de la page d'accueil}
  \begin{figure}
    \includegraphics[scale=0.22]{images/accueil.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}{\textit{Bootstrap et Font-Awesome}}{Front-end}
  \begin{figure}[!ht]
    \includegraphics[scale=0.04]{images/bootstrapLogo.jpg}
    \hfill
    \includegraphics[scale=0.10]{images/font_awesome.png}
  \end{figure}
  ...
  \begin{figure}[!ht]
    \includegraphics[scale=0.25]{images/header_navbar_component.png}
  \end{figure}
\end{frame}
%----------------------------------------------------------------------------------------
%   BACK-END
